...
class MCTS(object):
    ...
    def _playout(self, state, reward, done, env, min_max_stats):
        ...
        node.expand(action_priors=action_probs, reward=process_step_reward(
            reward, state['origin_num_nodes'], reward_reflect=True, reward_normalization=False, multi_step=False), done=done)
...
class MCTSAgent():
    ...
    def policy_update(self):
        ...
        batch_features, batch_adjacency_matrixs, batch_actions_probs, batch_rewards = \
